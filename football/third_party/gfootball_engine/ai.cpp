...
extern "C" {
  // Shim for PyObject_DelAttr and PyObject_DelAttrString
  // These are macros in Python headers but Boost.Python expects function symbols
  #undef PyObject_DelAttr
  #undef PyObject_DelAttrString
  int PyObject_DelAttr(PyObject *o, PyObject *attr_name) {
      return PyObject_SetAttr(o, attr_name, NULL);
  }
  int PyObject_DelAttrString(PyObject *o, const char *attr_name) {
      return PyObject_SetAttrString(o, attr_name, NULL);
  }
}
