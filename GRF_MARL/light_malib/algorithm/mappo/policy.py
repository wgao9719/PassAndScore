...
class MAPPO(Policy):
    ...
    def compute_action(self, **kwargs):
        ...
        with torch.set_grad_enabled(not inference):
            ...
            # Inject flash token into observations dict for actor/critic
            if EpisodeKey.FLASH_TOKEN in kwargs:
    ...
    def value_function(self, **kwargs):        
        ...
        with torch.set_grad_enabled(not inference):
            ...
            # Inject flash token into observations dict for critic
            if EpisodeKey.FLASH_TOKEN in kwargs:
                flash_token = kwargs[EpisodeKey.FLASH_TOKEN]
                if flash_token is not None:
                    states["flash_token"] = flash_token
